...
const LoginForm = ({ onLogin }: LoginFormProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-500 via-green-600 to-teal-700 dark:from-gray-900 dark:via-gray-900 dark:to-black flex items-center justify-center p-4 transition-colors">
      <div className="w-full max-w-md animate-fade-in">
        <div className="relative text-center mb-8">
          <button
            onClick={toggleTheme}
            className="absolute right-0 top-0 bg-white/20 backdrop-blur-sm p-2 rounded-full hover:bg-white/30 transition"
          >
            {theme === 'light' ? (
        ...
        <Card className="shadow-2xl backdrop-blur-sm bg-white/95 dark:bg-gray-900 dark:text-gray-100 border-0 transition-colors">
          <CardHeader className="text-center pb-4">
            <CardTitle className="flex items-center gap-2 justify-center text-2xl dark:text-white">
          ...
          <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-11 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-11 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
                    onKeyDown={(e) => e.key === 'Enter' && handleSubmit(e)}
                  />
                  <button
                    type="button"
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-gray-800 font-medium transition-all"
